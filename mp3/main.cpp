...
void testInserts()
{
    ...
    list.reverse();
	cout<<"[testInsertsReverse]: "<<list<<endl;
    if (list.size() != 10)
...
void testReverse(){
	...
	for (size_t i = 1; i <= 8; i++)
        list.insertBack(i);
    cout << "[testReverseS]: " << list << endl;
    list.reverse();
    cout<<"reverse done"<<endl;
    cout << "[testReverseFin]: " << list << endl;
}
/*void testReverse()
{
    cout << "[main]: " << __func__ << "()" << endl;
...
/*void testSplit(){
    ...
    List<int> rest = list.split(6);
    cout << "[testSplitFirst]: " << list << endl;
    cout << "[testSplitRest]: " << rest << endl;
} */
...
/*void testMerge(){
    ...
    cout << "[testMergeBefore]: " << list1 << endl;
...
void testSort(){
	...
	cout << "[testSort]: " << list1 << endl;
	list1.sort();
	cout << "[testSortResult]: " << list1 << endl;
}*/
