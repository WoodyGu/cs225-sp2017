...
int main()
{
     ...
     *because the shape's perimeter function cannot be overwritten, so Shape* shape still calls the perimeter for shape object
      after using virtual in shape, the shape object can call function from rectangle class*/
