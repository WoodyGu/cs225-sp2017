...
{
    /* Your code goes here! */
    string word1Upp = word1;
    string word2Upp = word2;
    std::transform(word1Upp.begin(), word1Upp.end(), word1Upp.begin(), ::toupper);
    std::transform(word2Upp.begin(), word2Upp.end(), word2Upp.begin(), ::toupper);
    auto pronunciation1 = dict.find(word1Upp);
    auto pronunciation2 = dict.find(word2Upp);
    if(pronunciation1 == dict.end()||pronunciation2 == dict.end()||pronunciation1->second!=pronunciation2->second){
      return false;
    }
    else{
      return true;
