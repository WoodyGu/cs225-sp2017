...
class BinaryTree
{
  public:
    ...
    void transformToBinaryR(Node *node, vector<Node *>siblingList,size_t nextSiblingIndex);

    void preorderTraversal(Node* croot);
  ...
  private:
    ...
    void printPaths(const Node* subRoot,std::vector<T> v) const;
