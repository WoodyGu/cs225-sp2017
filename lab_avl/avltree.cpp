...
template <class K, class V>
void AVLTree<K,V>::preOrderTraversalR(Node* subRoot){
  if(subRoot!=NULL){
    cout<<subRoot->value<<" ";
    preOrderTraversalR(subRoot->left);
    preOrderTraversalR(subRoot->right);
  }
}

template <class K, class V>
void AVLTree<K,V>::preOrderTraversal(){
  preOrderTraversalR(this->root);
}
